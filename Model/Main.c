...
int main()
{
    ...
    Player player1 = createPlayer(0, "player 1");
    Player player2 = createPlayer(1, "player 2");
    Game game = createGame(player1, player2, board);
    ...
    while (!exit)
    {
        ...
        {
            game = setGame(game, player1, player2, board);
            exit = 1;
        }
